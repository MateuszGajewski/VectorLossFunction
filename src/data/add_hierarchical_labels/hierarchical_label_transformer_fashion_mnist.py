...
class HierarchicalLabelTransformerFashionMnist():

    def __init__(self):
        self.new_categories_dict = {'0': ['9', '7', '5'],  # category for "Ankle boot", "Sneaker" and "Sandal"
                                    1: ['0', '2', '4', '6'],  # category for "T-shirt/top", "Pullover", "Coat", "Shirt"
                                    2: ['1', '3'],  # category for "Trouser" and "Dress"
                                    3: ['8']}  # category for "Trouser" and "Bag"
